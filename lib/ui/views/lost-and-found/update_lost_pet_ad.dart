...
class UpdateLostPetAd extends StatefulWidget {
  final LostAnimal lostAnimal;

  UpdateLostPetAd({required this.lostAnimal});

  @override
  _UpdateLostPetAdState createState() => _UpdateLostPetAdState();
}

class _UpdateLostPetAdState extends State<UpdateLostPetAd> {
  ...
  void initState() {
    ...
    _typeController.text = widget.lostAnimal.type;
    _nameController.text = widget.lostAnimal.name;
    _ageController.text = widget.lostAnimal.age;
    _contactNumberController.text = widget.lostAnimal.contactNumber;
    _descriptionController.text = widget.lostAnimal.description;
    _gender = widget.lostAnimal.gender;
    _selectedDate = widget.lostAnimal.lostDate;
    _isLost = widget.lostAnimal.isLost;
    _selectedPhotos = widget.lostAnimal.photos
  ...
  Future<void> _updateLostAnimal() async {
    ...
    LostAnimal updatedLostAnimal = LostAnimal(
      lostAnimalID: widget.lostAnimal.lostAnimalID,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(
        showBackButton: true,
        pageTitle: AppConstant.updateLostPetAdTitle,
      ),
      body: Container(
        color: bgColor,
