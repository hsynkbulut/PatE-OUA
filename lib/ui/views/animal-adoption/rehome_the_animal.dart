...
class RehomeTheAnimal extends StatefulWidget {
  const RehomeTheAnimal({super.key});

  @override
  State<RehomeTheAnimal> createState() => _RehomeTheAnimalState();
}

class _RehomeTheAnimalState extends State<RehomeTheAnimal> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(
        showBackButton: true,
        pageTitle: AppConstant.rehomeTheAnimalTitle,
      ),
      body: ListView(
          ...
          Container(
            ...
            child: Container(
              ...
              child: GridView.count(
                ...
                mainAxisSpacing: 30,
                children: [
                  itemDashboard('İlan Oluştur', CupertinoIcons.add,
                      primaryColor, AddPetAdoptionAnnouncement()),
                  itemDashboard('İlan Güncelle', CupertinoIcons.arrow_clockwise,
                      primaryColor, const UpdateAdoptionList()),
                  itemDashboard('İlan Sil', CupertinoIcons.delete, primaryColor,
                      const DeleteAdoptionAnnouncement()),
                  itemDashboard('İlan Görüntüle', CupertinoIcons.doc_text_fill,
                      primaryColor, const ViewMyAdoptionAnnouncement()),
                ],
              ),
            ),
          ),
